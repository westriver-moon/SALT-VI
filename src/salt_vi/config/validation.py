...
def _validate_numeric_ranges(config):
    integer_fields = {
        ...
        "pmt_metric_start_epoch": (0, None),
        "pmt_metric_ramp_epochs": (0, None),
    ...
    real_fields = (
        ...
        ("pmt_mscm_msel_weight", 0.0, None, False, False),
        ("pmt_mscm_dcl_weight", 0.0, None, False, False),
        ("pmt_mscm_qct_branch_weight", 0.0, None, False, False),
        ("pmt_mscm_aux_start_factor", 0.0, 1.0, False, False),
        ("pmt_backbone_lr_factor", 0.0, None, False, False),
        ("pmt_relation_weight", 0.0, None, False, False),
        ("pmt_intra_triplet_weight", 0.0, None, False, False),
