...
- H1–H4 的最高/最终结果、协议、配置和归档状态统一见 [`docs/status/README.md`](docs/status/README.md)；不要从旧报告中的“当前状态”句子建立排行榜。
...
- 本轮架构审计与清理记录见 docs/architecture/restructure_20260819.md。
- 本轮可复现归档规范和双账号资产核验记录见 `docs/operations/archive_plan_20260822.md`。
- 2026-08-24 documentation consolidation and cleanup: docs/operations/cleanup_20260824.md.
